...
HD_PWD='C:/Internship/hdl/hdl/projects/ad5592r_pmdz/zyboz7/ad5592r_zyboz7.runs/system_axi_pwm_led_generator_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_pwm_led_generator_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_pwm_led_generator_0.tcl
